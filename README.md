...
- 지역별 안전 정보 게시 및 공유
- 지도 기반 안전 정보 시각화
- **AI 기반 안전 지역 추천 (Gemini) - 실제 거주민 후기 기반 상세 분석**
...
2. "AI에게 추천받기" 버튼 클릭
3. AI가 분석한 안전 지역 추천 결과와 **실제 거주민 후기를 근거로 한 구체적인 추천 이유** 확인
...
- 데이터베이스에 충분한 Post 데이터와 게시글 내용(contents)이 있어야 의미있는 추천이 가능합니다.
- 추천의 정확도는 사용자들이 작성한 게시글의 품질과 양에 따라 달라집니다.
